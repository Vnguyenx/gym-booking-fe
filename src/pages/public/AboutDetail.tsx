...
// src/pages/home/AboutDetail.tsx
//
// Không gọi useGymData trực tiếp nữa — đọc từ Redux store.
// useGymData vẫn được gọi để đảm bảo data được fetch nếu user
// vào thẳng trang này (không qua HomePage).
// ============================================================

import React from 'react';
import { useSelector } from 'react-redux';
import { RootState } from '../../store';
import { useGymData } from '../../hooks/useGymData'; // trigger fetch nếu chưa có
...
const AboutDetailPage: React.FC = () => {
    // Trigger fetch nếu user vào thẳng URL này (chưa qua HomePage)
    useGymData();

    const { gymInfo, floors, zones, loading } = useSelector(
                ...
                <div className="container">
                    ...
                    <section className="detail-section">
                        <div className="container">
                            ...
                            <p className="section-intro">Tổng số tầng: {gymInfo?.totalFloors}. Được thiết kế hiện đại, tối ưu
                                cho từng bộ môn tập luyện.</p>
